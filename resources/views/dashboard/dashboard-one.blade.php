                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column flex-sm-row align-items-center mb-3">
                        <img class="avatar-lg mb-3 mb-sm-0 rounded me-sm-3"
                            src="{{ asset('assets/images/products/headphone-4.jpg') }}" alt="">
                    ...
                    <div class="d-flex flex-column flex-sm-row align-items-center mb-3">
                        <img class="avatar-lg mb-3 mb-sm-0 rounded me-sm-3"
                            src="{{ asset('assets/images/products/headphone-2.jpg') }}" alt="">
                        <div class="flex-grow-1">
                    ...
                    <div class="d-flex flex-column flex-sm-row align-items-center mb-3">
                        <img class="avatar-lg mb-3 mb-sm-0 rounded me-sm-3"
                            src="{{ asset('assets/images/products/headphone-3.jpg') }}" alt="">
                        <div class="flex-grow-1">
