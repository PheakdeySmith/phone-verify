       ...
       <div class="breadcrumb">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center border-bottom-dotted-dim pb-3 mb-3">
                                <img class="avatar-md rounded me-3" src="{{asset('assets/images/faces/2.jpg')}}" alt="">
                            ...
                            <div class="d-flex align-items-center border-bottom-dotted-dim pb-3 mb-3">
                                <img class="avatar-md rounded me-3" src="{{asset('assets/images/faces/3.jpg')}}" alt="">
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center border-bottom-dotted-dim pb-3 mb-3">
                                <img class="avatar-md rounded me-3" src="{{asset('assets/images/faces/4.jpg')}}" alt="">
                                <div class="flex-grow-1">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card o-hidden mb-4">
                        <div class="card-header">
                            <h3 class="w-50 float-start card-title m-0">Total Sales</h3>
                            <div class="dropdown dropleft text-end w-50 float-end">
