...
@section('main-content')
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card o-hidden mb-4">
                        <div class="card-header">
                            <h3 class="w-50 float-start card-title m-0">Sales</h3>
                            <div class="dropdown dropleft text-end w-50 float-end">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card o-hidden mb-4">
                        <div class="card-header">
                            <h3 class="w-50 float-start card-title m-0">New Users in Datatable</h3>
                            <div class="dropdown dropleft text-end w-50 float-end">
                ...
                <div class="col-md-6">
                    <div class="card o-hidden mb-4">
                        <div class="card-header">
                            <h3 class="w-50 float-start card-title m-0">Sales in Datatable</h3>
                            <div class="dropdown dropleft text-end w-50 float-end">
