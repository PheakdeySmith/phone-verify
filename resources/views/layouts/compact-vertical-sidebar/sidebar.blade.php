    ...
    <div class="sidebar-left-secondary rtl-ps-none" data-perfect-scrollbar data-suppress-scroll-x="true">
        ...
        <div class="submenu-area" data-parent="uikits">
            ...
            <ul class="childNav" data-parent="uikits">
                ...
                <li class="nav-item">
                    <a class="{{ Route::currentRouteName() == 'badges' ? 'open' : '' }}"
                        href="{{ route('badges') }}">
                ...
                <li class="nav-item">
                    <a class="{{ Route::currentRouteName() == 'buttons' ? 'open' : '' }}"
                        href="{{ route('buttons') }}">
                ...
                <li class="nav-item">
                    <a class="{{ Route::currentRouteName() == 'popover' ? 'open' : '' }}"
                        href="{{ route('popover') }}">
                ...
                <li class="nav-item">
                    <a class="{{ Route::currentRouteName() == 'tables' ? 'open' : '' }}"
                        href="{{ route('tables') }}">
                        <i class="nav-icon i-File-Horizontal-Text"></i>
                ...
                <li class="nav-item">
                    <a class="{{ Route::currentRouteName() == 'tooltip' ? 'open' : '' }}"
                        href="{{ route('tooltip') }}">
                ...
                <li class="nav-item">
                    <a class="{{ Route::currentRouteName() == 'modals' ? 'open' : '' }}"
                        href="{{ route('modals') }}">
