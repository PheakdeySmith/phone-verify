...
<div class="sidebar-panel">
    <div class="gull-brand pe-3 text-center mt-4 mb-2 d-flex justify-content-center align-items-center">
        <img class="ps-3" src="{{ asset('assets/images/logo.png') }}" alt="">
    ...
    <div class="scroll-nav" data-perfect-scrollbar data-suppress-scroll-x="true">
        ...
        <div class="side-nav">
            ...
            <div class="main-menu">
                ...
                <!-- <ul>
                            <li>
                                <a href="*" class="active-color">
                                    ...
                                    <span class="item-badge badge text-bg-warning">100+</span>
                                </a>
                            </li>

                        </ul> -->
                <ul class="metismenu" id="menu">
                    <!-- <p class="main-menu-title text-muted ms-3 font-weight-700 text-13 mt-4 mb-2">Apps</p> -->
                    <li class="Ul_li--hover">
                        <a class="" href="{{ route('dashboard_version_1') }}">
                ...
                <li class="Ul_li--hover">
                    <a class="has-arrow" href="#">
                        <i class="i-Suitcase text-20 me-2 text-muted"></i>
                ...
                <li class="Ul_li--hover">
                    <a class="has-arrow" href="#">
                        <i class="i-Computer-Secure text-20 me-2 text-muted"></i>
                ...
                <!-- <p class="main-menu-title text-muted ms-3 font-weight-700 text-13 mt-4 mb-2">UI Elements</p> -->
                <li class="Ul_li--hover">
                    <a class="has-arrow" href="#">
                        <i class="i-Computer-Secure text-20 me-2 text-muted"></i>
                ...
                <li class="Ul_li--hover">
                    <a class="has-arrow">
                        <i class="i-Double-Tap text-20 me-2 text-muted"></i>
                ...
                <li class="Ul_li--hover">
                    <a class="" href="http://demos.ui-lib.com/gull-htms-doc/">
                        <i class="i-Safe-Box1 text-20 me-2 text-muted"></i>
