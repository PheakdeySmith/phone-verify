    ...
    <div class="sidebar-left-secondary rtl-ps-none" data-perfect-scrollbar data-suppress-scroll-x="true">
        ...
        <ul class="childNav" data-parent="widgets">
            ...
            <li class="nav-item">
                ...
                <a class="{{ Route::currentRouteName() == 'widget-list' ? 'open' : '' }}"
                    href="{{ route('widget-list') }}">
                    <i class="nav-icon i-Receipt-4"></i>
                    <span class="item-name">Widget List <span class="ms-2 badge badge-pill text-bg-danger">
                            New</span></span>
                </a>
            </li>
            ...
            <li class="nav-item">
                ...
                <a class="{{ Route::currentRouteName() == 'widget-app' ? 'open' : '' }}"
                    ...
                    <i class="nav-icon i-Receipt-4"></i>
                    <span class="item-name">Widget App <span class="ms-2 badge badge-pill text-bg-danger"> New</span>
                    </span>
                </a>
            </li>
            <li class="nav-item">
        ...
        <ul class="childNav" data-parent="uikits">
            ...
            <li class="nav-item">
                <a class="{{ Route::currentRouteName() == 'accordion' ? 'open' : '' }}"
                    href="{{ route('accordion') }}">
            ...
            <li class="nav-item">
                <a class="{{ Route::currentRouteName() == 'carousel' ? 'open' : '' }}"
                    href="{{ route('carousel') }}">
            ...
            <li class="nav-item">
                <a class="{{ Route::currentRouteName() == 'collapsible' ? 'open' : '' }}"
                    href="{{ route('collapsible') }}">
                    <i class="nav-icon i-Video-Photographer"></i>
            ...
            <li class="nav-item">
                <a class="{{ Route::currentRouteName() == 'typography' ? 'open' : '' }}"
        ...
        <ul class="childNav" data-parent="others">
            ...
            <li class="nav-item">
                <a class="{{ Route::currentRouteName() == 'search-result' ? 'open' : '' }}"
                    ...
                    <span class="item-name">Search Result <span
                            class="badge badge-pill text-bg-danger">New</span></span>
                </a>
            </li>
            <li class="nav-item">
