...
<head>
    ...
    <title>Gull - laravel 11+ Bootstrap 5 admin template</title>
    ...
    <!-- New Vite directives -->
    @vite(['resources/js/app.js', 'resources/gull/assets/styles/sass/themes/lite-purple.scss', 'resources/gull/assets/js/script.js'])
