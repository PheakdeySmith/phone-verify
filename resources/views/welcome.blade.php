                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ms-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs"
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ms-4 text-lg leading-7 font-semibold"><a href="https://laracasts.com"
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center">
                            ...
                            <div class="ms-4 text-lg leading-7 font-semibold"><a href="https://laravel-news.com/"
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ms-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Vibrant
                                Ecosystem</div>
                        </div>
            ...
            <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                <div class="text-center text-sm text-gray-500 sm:text-start">
                    <div class="flex items-center">
                        ...
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2" viewBox="0 0 24 24" class="ms-4 -mt-px w-5 h-5 text-gray-400">
                            <path
