                ...
                <div class="card">
                    <div class="card-header bg-success p-3">
                        <div class="ul-weather-card__header">
                            <i class="i-Map-Marker ul-weather-card__font-md text-white me-2"></i>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 ul-weather-card__both-group">
                            ...
                            <div class="ul-weather-card__info">
                                ...
                                <span class="t-font-bold me-3">60%</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card o-hidden">
                    ...
                    <div class="ul-weather-card__img-overlay-2">
                        <div class="d-flex no-block align-items-center">
                            ...
                            <div class="ms-auto">
                                <span><i class="i-Map-Marker me-2 ul-weather-card__font-md "></i></span>
                            </div>
                        </div>
            ...
            <div class="col-lg-6 col-xl-6 text-center">
                <div class="card o-hidden mb-4">
                    <div class="card-header indigo-400">
                        <div class="d-inline-block">
                            <i class="i-Cloud-Sun display-4 text-white t-font-boldest me-3"></i>
                ...
                <div class="card o-hidden">
                    <div class="card-header pink-500 text-center">
                        <div class="d-inline-block">
                            ...
                            <span class="font-25 text-white">C /9<sup>o</sup> C</span>
                            <i class="i-Clouds display-4 text-white t-font-boldest ms-3"></i>
                        </div>
                    </div>
                    <div class="card-title ul-weather-card__footer-color-2  bg-white">
                        <div class="ul-weather-card__info mt-2">
                            <span class="t-font-bold ms-2 t-font-boldest">40 kmph</span>
                            <span class="t-font-bold me-2 t-font-boldest">60%</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card o-hidden mb-4">
                    <div class="card-header teal-300 p-5">
                        <div class="ul-weather-card__grid-style">
                            <i class="i-Cloud-Sun display-4 t-font-boldest text-white me-3"></i>
                            <span class="display-5 font-25 text-white ">30<sup>o</sup></span>
                            <span class="me-3 text-white ul-weather-card__weather-s-title">Sunny</span>
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-xl-6 ">
                <div class="card">
                    <div class="card-body text-center p-4">
                        <i class="i-Clouds display-4 t-font-boldest text-mute me-3"></i>
                    </div>
                    <div class="card-footer bg-dark">
                        <div class="ul-weather-card__footer">
                            <div class="d-flex no-block align-items-center">
                                <div class="text-center">
                                    <h3 class="text-white"><i class="text-success i-Arrow-Up t-font-boldest"></i> 24° C
                                    </h3>
                                    <h5 class="text-white">High</h5>
                                </div>
                                <div class="ms-auto">
                                    <div class="text-center">
                                        <h3 class="text-white"><i class="text-danger i-Arrow-Down t-font-boldest"></i> 7°
                                            C
                                        </h3>
