...
Route::get('large-sidebar/dash/dashboard1', function () {
    // set layout sesion(key)
    session(['layout' => 'normal']);
    return view('dashboard.dashboard-one');
})->name('normal');

Route::get('horizontal-bar/dash/dashboard1', function () {
    // set layout sesion(key)
    session(['layout' => 'horizontal']);
    return view('dashboard.dashboard-one');
})->name('horizontal');

Route::get('vertical/dash/dashboard1', function () {
    // set layout sesion(key)
...
Route::view('dash/dashboard-one', 'dashboard.dashboard-one')->name('dashboard_version_1');
Route::view('dash/dashboard-two', 'dashboard.dashboard-two')->name('dashboard_version_2');
Route::view('dash/dashboard-three', 'dashboard.dashboard-three')->name('dashboard_version_3');
Route::view('dash/dashboard-four', 'dashboard.dashboard-four')->name('dashboard_version_4');
...
Route::view('sessions/login', 'sessions.signIn')->name('login');
Route::view('sessions/register', 'sessions.signUp')->name('register');
